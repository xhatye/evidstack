...
export const GOALS = [
  ...
  { id: "hormones",  label: "Testostérone",    icon: "🩸" },
...
export const SUPPLEMENTS = [
  {
    ...
    effects: [
      ...
      { goal: "focus",    efficacy: 2, evidence: 2, studies: 3, type: "Observational",
        summary: "Correlation between magnesium deficiency and cognitive difficulties. Limited RCT data in healthy subjects.", summary_fr: "Corrélation entre déficience en Mg et difficultés cognitives. Peu d'RCT sur sujets sains.", sources: ["PMID:30987086"] },
      { goal: "recovery", efficacy: 2, evidence: 2, studies: 4, type: "RCT",
        summary: "Slightly reduces muscle cramps. Limited effects on DOMS.", summary_fr: "Réduit légèrement les crampes musculaires. Effets sur DOMS limités.", sources: ["PMID:31896752"] },
...

  {
    ...
    effects: [
      ...
      { goal: "mood",     efficacy: 3, evidence: 4, studies: 25, type: "RCT + meta-analyses",
        summary: "Strong correlation between deficiency and depression. RCTs show depression score improvement. Effect appears within 8-12 weeks.", summary_fr: "Corrélation forte déficience/dépression. RCT montrent amélioration des scores dépressifs. Effet en 8–12 semaines.", sources: ["PMID:24632894"] },
      { goal: "longevity",efficacy: 4, evidence: 4, studies: 40, type: "Meta-analyses",
        summary: "Reduces all-cause mortality by ~10%, cardiovascular mortality, and cancer risk. Solid observational data.", summary_fr: "Réduction mortalité toutes causes ~10%, mortalité cardiovasculaire, cancer. Données observationnelles solides.", sources: ["PMID:29635313"] },
      ...
      { goal: "cardio",   efficacy: 3, evidence: 3, studies: 15, type: "RCT",
        summary: "K2 reduces arterial calcification. D3 improves insulin sensitivity and lipid profile.", summary_fr: "K2 réduit calcification artérielle. D3 améliore la sensibilité à l'insuline et le profil lipidique.", sources: ["PMID:15514282"] },
    ],
  },

  {
    ...
    legal: "OTC everywhere",
    cost: "$8-$15/month",
    dosage: { amount: "15–30 mg/jour", timing: "À distance des repas riches en phytates (pain, céréales)", note: "Do not exceed 40mg/day. Bisglycinate > gluconate for absorption" },
    ...
    effects: [
      ...
      { goal: "longevity",efficacy: 3, evidence: 3, studies: 15, type: "RCT",
        summary: "Antioxidant role, regulates NF-kB. Reduces chronic inflammation. Essential for immunity.", summary_fr: "Rôle antioxydant, régule NF-κB. Réduit inflammation chronique. Essentiel pour immunité.", sources: ["PMID:12730442"] },
...

  {
    ...
    effects: [
      ...
      { goal: "focus",    efficacy: 3, evidence: 3, studies: 20, type: "RCT",
        summary: "Improves processing speed and working memory. DHA is structural to neuronal membranes.", summary_fr: "Améliore vitesse de traitement, mémoire de travail. DHA structural pour membranes neuronales.", sources: ["PMID:29215971"] },
      ...
      { goal: "recovery", efficacy: 3, evidence: 3, studies: 18, type: "RCT",
        summary: "Reduces DOMS and improves muscle recovery. Role in post-exercise protein synthesis.", summary_fr: "Réduit DOMS, améliore récupération musculaire. Rôle dans synthèse protéique post-effort.", sources: ["PMID:19234590"] },
      { goal: "skin",     efficacy: 3, evidence: 3, studies: 12, type: "RCT",
        summary: "Skin hydration, reduction of psoriasis and eczema. Partial UV protection.", summary_fr: "Hydratation cutanée, réduction psoriasis et eczéma. Protection UV partielle.", sources: ["PMID:15781130"] },
    ],
  },

  {
    ...
    effects: [
      ...
      { goal: "force",    efficacy: 3, evidence: 3, studies: 12, type: "RCT",
        summary: "+1.5 to 2x greater strength gains vs placebo over 8 weeks of resistance training. Increases VO2max.", summary_fr: "+1.5 à 2x plus de gain de force vs placebo sur 8 semaines de musculation. Augmente VO2max.", sources: ["PMID:25667198"] },
      ...
      { goal: "focus",    efficacy: 2, evidence: 2, studies: 6, type: "RCT",
        summary: "Improved working memory and reaction time. Limited data.", summary_fr: "Amélioration mémoire de travail et temps de réaction. Données limitées.", sources: ["PMID:28471731"] },
    ],
  },

  {
    ...
    legal: "OTC everywhere",
    cost: "$8-$15/month",
    dosage: { amount: "100–200 mg", timing: "Avec caféine (4:1 ratio théanine:caféine) pour focus, seule le soir pour relaxation", note: "Caffeine + theanine synergy = gold standard for focus without anxiety" },
    interactions: [],
    effects: [
      ...
      { goal: "stress",   efficacy: 3, evidence: 4, studies: 18, type: "RCT",
        summary: "Increases alpha waves (EEG). Reduces acute stress response. Mild anxiolytic without sedation.", summary_fr: "Augmente ondes alpha (EEG). Réduit réponse au stress aigu. Anxiolytique léger sans sédation.", sources: ["PMID:19752807"] },
      { goal: "sleep",    efficacy: 3, evidence: 3, studies: 10, type: "RCT",
        summary: "Improves subjective sleep quality. Reduces nightmares. Most effective without caffeine (evening dose).", summary_fr: "Améliore qualité subjective du sommeil. Réduit cauchemars. Meilleur sans caféine (dose soir).", sources: ["PMID:22214254"] },
      { goal: "mood",     efficacy: 2, evidence: 2, studies: 5, type: "RCT",
        summary: "Slight mood improvement. Synergistic with caffeine. Alone: limited data.", summary_fr: "Légère amélioration humeur. Effet synergique avec caféine. Seule : données limitées.", sources: ["PMID:23107346"] },
    ],
  },

  {
    ...
    effects: [
      { goal: "focus",    efficacy: 5, evidence: 5, studies: 500, type: "Meta-analyses",
        summary: "The most documented effect in behavioral pharmacology. Improves alertness, reaction time, and working memory. Incontestable.", summary_fr: "Effet le plus documenté de toute la pharmacologie comportementale. Améliore vigilance, temps de réaction, mémoire de travail. Incontestable.", sources: ["PMID:24861208","PMID:16541243"] },
      ...
      { goal: "force",    efficacy: 3, evidence: 4, studies: 40, type: "Meta-analyses",
        summary: "+2–4% force maximale, +4–8% puissance. Effets significatifs en force et sports d'endurance.", sources: ["PMID:29876876"] },
      { goal: "mood",     efficacy: 3, evidence: 4, studies: 30, type: "Epidemiological",
        summary: "Inverse correlation between coffee and depression (meta-analysis 350k+ people). Mechanism: dopamine and adenosine.", summary_fr: "Corrélation inverse café/dépression (méta 350k+ personnes). Mécanisme : dopamine et adénosine.", sources: ["PMID:26944757"] },
      { goal: "stress",   efficacy: -2, evidence: 4, studies: 20, type: "RCT",
        summary: "NEGATIVE EFFECT: Increases cortisol, anxiety, and heart rate. Counterproductive with chronic stress.", summary_fr: "⚠️ EFFET NÉGATIF : Augmente cortisol, anxiété et fréquence cardiaque. Contreproductif si stress chronique.", sources: ["PMID:18078812"] },
    ],
  },

  {
    ...
    effects: [
      { goal: "memory",   efficacy: 3, evidence: 3, studies: 12, type: "RCT",
        summary: "Stimulates NGF (nerve growth factor). Improves memory and mild cognition in older adults. Emerging data in younger adults.", summary_fr: "Stimule NGF (facteur de croissance nerveux). Améliore mémoire et cognition légère chez seniors. Données émergentes chez jeunes adultes.", sources: ["PMID:18844328","PMID:23756457"] },
      { goal: "focus",    efficacy: 3, evidence: 2, studies: 6, type: "Preliminary RCT",
        summary: "Improved attention and processing speed. Mechanism: NGF + reduction of brain inflammation.", summary_fr: "Amélioration attention et vitesse de traitement. Mécanisme NGF + réduction inflammation cérébrale.", sources: ["PMID:31413233"] },
