Warning: truncated output (original token count: 142427)
Total output lines: 7837
  ...
  return(
    <div className="evid-pro-tool-page" style={{maxWidth:840,margin:"0 auto",padding:isMob?"32px 16px 60px":"56px 48px 100px"}}>
      ...
      <div style={{marginBottom:32}}>
        <p style={{fontSize:11,fontWeight:800,color:C.ink,letterSpacing:".1em…42427 tokens truncated…ade to Pro</button>
    </div></div>
  );
